  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rating as @rating" do
        ...
        post :create, {:rating => { "points" => "invalid value" }}, valid_session
        assigns(:rating).should be_a_new(Rating)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rating" do
        ...
        Rating.any_instance.should_receive(:update).with({ "points" => "1" })
        put :update, {:id => rating.to_param, :rating => { "points" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rating as @rating" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rating.any_instance.stub(:save).and_return(false)
        put :update, {:id => rating.to_param, :rating => { "points" => "invalid value" }}, valid_session
        assigns(:rating).should eq(rating)
      end
